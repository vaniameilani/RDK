            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">{{ __('Nomor Telepon/HP') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <input type="radio" id="ikhwan" name="jenis_kelamin" value="Ikhwan">
                            <label for="masuk">Ikhwan</label>
                            <br>
                            <input type="radio" id="akhwat" name="jenis_kelamin" value="Akhwat">
                            <label for="keluar">Akhwat</label>
                            <br>
                                {{-- </div> --}}
                            {{-- </div> --}}
                        </div>
